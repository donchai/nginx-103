...
Copy, and paste following text as path value into `Name` field.<br>
```bash
devportal
```
Copy, and paste following text as path value into `Hostname` field, click `Create` button once ready.<br>
```bash
nginx-devportal
```
